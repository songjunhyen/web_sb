...
public interface UserDao {
	...
	@Insert({ "INSERT INTO `login_user` (userid, nickname, login_code)",
			"VALUES (#{userid}, #{nickname}, #{loginCode})", "ON DUPLICATE KEY UPDATE",
			"    nickname = VALUES(nickname),", "    login_code = VALUES(login_code)" })
